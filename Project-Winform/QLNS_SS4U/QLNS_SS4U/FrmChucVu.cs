...
namespace QLNS_SS4U
{
    public partial class FrmChucVu : Form
    {
        ...
        private void KhongdungPar()
        {
            ...
            string ngaytao = dateTimePickerNgaySua.Value.ToString("yyyy-MM-dd");
            ...
            SqlCommand sqlCmd = new SqlCommand();
            sqlCmd.CommandType = CommandType.Text;
            sqlCmd.CommandText = "Insert into ChucVu values ('" + id + "', '" + tenchucvu + "'," +
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sqlCmd = new SqlCommand();
            sqlCmd.CommandType = CommandType.Text;
            sqlCmd.CommandText = "update ChucVu set MaChucvu = '" + txtID.Text.Trim() + "', TenChucVu = N'" + txtTenchucvu.Text.Trim() + "'," +
                "NgayTao = '" + dateTimePickerNgayTao.Value.ToString("yyyy-MM-dd") + "', NgayChinhSua = '" + dateTimePickerNgaySua.Value.ToString("yyyy-MM-dd") + "', BiXoa = '" + (ckbTinhTrang.Checked ? "1" : "0") + "' where MaChucVu = '" + txtID.Text.Trim() + "'";
            sqlCmd.Connection = sqlCon;
        ...
        private void lvChucVu_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtTongMau.Text = lvChucVu.Items.Count.ToString();
            ...
            DateTime ngayTao = DateTime.ParseExact(lvi.SubItems[2].Text, "dd/MM/yyyy", CultureInfo.InvariantCulture);
            dateTimePickerNgayTao.Text = ngayTao.ToString("yyyy-MM-dd");

            DateTime ngaySua = DateTime.ParseExact(lvi.SubItems[3].Text, "dd/MM/yyyy", CultureInfo.InvariantCulture);
        ...
        private void DisplayData()
        {
            if (currentIndex >= 0 && currentIndex < lvChucVu.Items.Count)
            {
                ...
                DateTime ngayTao = DateTime.ParseExact(selectedItem.SubItems[2].Text, "dd/MM/yyyy", CultureInfo.InvariantCulture);
                dateTimePickerNgayTao.Text = ngayTao.ToString("yyyy-MM-dd");

                DateTime ngaySua = DateTime.ParseExact(selectedItem.SubItems[3].Text, "dd/MM/yyyy", CultureInfo.InvariantCulture);
                dateTimePickerNgaySua.Text = ngaySua.ToString("yyyy-MM-dd");

                string dangLamViec = selectedItem.SubItems[4].Text;
                ckbTinhTrang.Checked = (dangLamViec == "True");
        ...
        private void btnTim_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sqlCmd = new SqlCommand();
            sqlCmd.CommandType = CommandType.Text;
            sqlCmd.CommandText = "SELECT * FROM ChucVu WHERE MaChucvu = @MaChucvu";
            sqlCmd.Connection = sqlCon;

            // Thêm tham số ID vào câu truy vấn
            sqlCmd.Parameters.AddWithValue("@MaChucvu", searchID);
